            ...
            <tr>
                ...
                <td>
                    <x-dropdown-table>
                        ...
                        <a class="dropdown-item" href="{{ route('dashboard.partners.active', $partner->id) }}"><i class="bx bx-edit-alt me-1"></i>
                ...
                <x-modal id="ModalEditPartner-{{ $partner->id, $partner->name, $partner->desc, $partner->image  }}" :title="'edit'">
                    ...
                    <x-slot:body>
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <label for="nameWithTitle" class="form-label">@lang('index.partner.name') <span class="text-lowercase">\(English)</span> </label>
