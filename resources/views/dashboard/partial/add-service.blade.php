    ...
    <form action="{{ route('dashboard.service.store') }}" class="card-body" method="post" enctype="multipart/form-data" novalidat>
        ...
        <div class="row g-3">
            <div class="form-group">
                ...
                <textarea id="service_condition_ar" value="{{ old('service_condition_ar') }}" class="ckeditor form-control @error('service_condition_ar') is-invalid @enderror" name="service_condition_ar"></textarea>
            ...
            <div class="form-group">
                ...
                <textarea id="service_condition_en" value="{{ old('service_condition_en') }}" class="ckeditor form-control @error('service_condition_en') is-invalid @enderror" name="service_condition_en"></textarea>
